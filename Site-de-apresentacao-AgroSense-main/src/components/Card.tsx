    ...
    <StyledWrapper>
      <div className="cardm">
        <div className="card">
          ...
          <div className="main">{displayData.temperature}°C</div>
          <div className="mainsub">{displayData.location}</div>
          {isLoading && <div className="loading">Carregando...</div>}
          {hasError && <div className="error">Erro ao carregar dados</div>}
        </div>
        <div className="card2">
          <div className="upper">
            <div className="humidity">
              <div className="humiditytext">Humidity<br />{displayData.humidity}%</div>
              <svg xmlSpace="preserve" viewBox="0 0 30 30" height="30px" width="30px" y="0px" x="0px" xmlnsXlink="http://www.w3.org/1999/xlink" xmlns="http://www.w3.org/2000/svg" id="Layer_1" version="1.1" className="humiditysvg">  
          ...
          KHRFWHRkYXRlOnRpbWVzdGFtcAAyMDIzLTAyLTE2VDE4OjE5OjAwKzAwOjAwSbgwlgAAAABJRU5ErkJggg==" y={0} x={0} height={30} width={30} id="image0" />
            ...
            <div className="air">
              <div className="airtext">Wind<br />{displayData.windSpeed} Km/h</div>
          ...
          MjUrMDA6MDBiirAvAAAAAElFTkSuQmCC" />
              ...
              <div className="aqitext">AQI<br />{displayData.aqi}</div>
            </div>
          ...
          OFQwNToxNToyNiswMDowMIjQlfwAAAAASUVORK5CYII=" />
              ...
              <div className="realfeeltext">Real Feel<br />{displayData.feelsLike}°C</div>
            </div>
            <div className="pressure">
              <svg className="pressuresvg" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="20px" height="20px" viewBox="0 0 20 20" xmlSpace="preserve">  
               <image id="image0" width={20} height={20} x={0} y={0} href="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAABQAAAAUCAMAAAC6V+0/AAAABGdBTUEAALGPC/xhBQAAACBjSFJN
...
const StyledWrapper = styled.div`
  ...
  /* Substituir esta parte no media query mobile: */
